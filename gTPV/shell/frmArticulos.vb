...
#Region "Eventos Auxiliares"
    ...
    Private Sub chkComposicion_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkComposicion.CheckedChanged
        ...
        Me.btComposición.Enabled = Me.chkComposicion.Checked
    End Sub
...
#Region "Códigos de Barras"
    Private Sub BtCodBarras_Add_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtCodBarras_Add.Click
        ...
        'Realizo comprobacion de que el código de barras no esta asignado a ningun artículo
        ...
        If rstAux.RecordCount > 0 Then
            ...
            Else
                MsgBox("Imposible asignar el código de barras al artículo, puesto que ya se encuentra asignado a otro artículo.", MsgBoxStyle.Critical)
            End If
        ...
        For i = 0 To Me.LstCodBarras.Items.Count - 1
            If Me.LstCodBarras.Items(i).ToString = frmGetCodBarras.StrCode Then
                MsgBox("No se puede asignar el mismo código de barras dos veces al artículo.", MsgBoxStyle.Critical)
                frmGetCodBarras.Dispose()
                Exit Sub
            End If
        Next
...
#End Region
    ...
    Private Sub btComposición_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btComposición.Click
