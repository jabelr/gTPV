...
#Region "Eventos Delegados"
    ...
    Public Sub OnNewField()
        ...
        'Tabs
        If Me.Tab.TabPages.Contains(Me.TabPage_Historial) Then Me.Tab.TabPages.Remove(Me.TabPage_Historial)
    End Sub
    ...
    Public Sub OnLoadField(ByVal id As Integer)
        ...
        'Tabs
        If Not Me.Tab.TabPages.Contains(Me.TabPage_Historial) Then Me.Tab.TabPages.Add(Me.TabPage_Historial)
    End Sub
