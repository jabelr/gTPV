...
Public Class crtCaja_Entradas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "gTPV.crtCaja_Entradas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrtCaja_Entradas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crtCaja_Entradas = New crtCaja_Entradas()
        rpt.Site = Me.Site
        Return rpt
    End Function
