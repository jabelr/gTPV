...
Public Class crtCaja_Usuarios
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "gTPV.crtCaja_Usuarios.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrtCaja_Usuarios
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crtCaja_Usuarios = New crtCaja_Usuarios()
        rpt.Site = Me.Site
        Return rpt
    End Function
