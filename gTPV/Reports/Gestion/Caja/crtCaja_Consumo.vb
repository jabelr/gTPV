...
Public Class crtCaja_Consumo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "gTPV.crtCaja_Consumo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrtCaja_Consumo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crtCaja_Consumo = New crtCaja_Consumo()
        rpt.Site = Me.Site
        Return rpt
    End Function
