...
Public Class crtCaja_Sencillo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "gTPV.crtCaja_Sencillo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrtCaja_Sencillo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crtCaja_Sencillo = New crtCaja_Sencillo()
        rpt.Site = Me.Site
        Return rpt
    End Function
