...
Public Class crtCaja_CajaActual
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "gTPV.crtCaja_CajaActual.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrtCaja_CajaActual
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crtCaja_CajaActual = New crtCaja_CajaActual()
        rpt.Site = Me.Site
        Return rpt
    End Function
