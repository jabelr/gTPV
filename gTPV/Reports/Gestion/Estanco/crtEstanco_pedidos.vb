...
Public Class crtEstanco_pedidos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "gTPV.crtEstanco_pedidos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrtEstanco_pedidos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crtEstanco_pedidos = New crtEstanco_pedidos()
        rpt.Site = Me.Site
        Return rpt
    End Function
