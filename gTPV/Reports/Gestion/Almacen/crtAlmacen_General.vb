...
Public Class crtAlmacen_General
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "gTPV.crtAlmacen_General.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrtAlmacen_General
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crtAlmacen_General = New crtAlmacen_General()
        rpt.Site = Me.Site
        Return rpt
    End Function
