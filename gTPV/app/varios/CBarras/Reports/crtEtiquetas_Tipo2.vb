...
Public Class crtEtiquetas_Tipo2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "gTPV.crtEtiquetas_Tipo2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrtEtiquetas_Tipo2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crtEtiquetas_Tipo2 = New crtEtiquetas_Tipo2()
        rpt.Site = Me.Site
        Return rpt
    End Function
