...
Public Class crtEtiquetas_4x11
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "gTPV.crtEtiquetas_4x11.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrtEtiquetas_4x11
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crtEtiquetas_4x11 = New crtEtiquetas_4x11()
        rpt.Site = Me.Site
        Return rpt
    End Function
