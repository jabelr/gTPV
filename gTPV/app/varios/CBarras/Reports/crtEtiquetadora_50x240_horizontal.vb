...
Public Class crtEtiquetadora_50x240_horizontal
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "crtEtiquetadora_50x240_horizontal.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "gTPV.crtEtiquetadora_50x240_horizontal.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_pic() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedcrtEtiquetadora_50x240_horizontal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crtEtiquetadora_50x240_horizontal = New crtEtiquetadora_50x240_horizontal()
        rpt.Site = Me.Site
        Return rpt
    End Function
