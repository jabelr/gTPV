...
Public Class crtEtiquetas_4x10
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "gTPV.crtEtiquetas_4x10.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrtEtiquetas_4x10
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crtEtiquetas_4x10 = New crtEtiquetas_4x10()
        rpt.Site = Me.Site
        Return rpt
    End Function
