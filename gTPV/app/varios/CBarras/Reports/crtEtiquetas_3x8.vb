...
Public Class crtEtiquetas_3x8
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "gTPV.crtEtiquetas_3x8.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrtEtiquetas_3x8
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crtEtiquetas_3x8 = New crtEtiquetas_3x8()
        rpt.Site = Me.Site
        Return rpt
    End Function
