Public Class frmConfigure_ConceptoVarios
    Public Id_Ref As Integer = 0
    Private m_Data As gDevelop.Lite.m_dataform

#Region "Eventos Principales"
    Private Sub frmConfigure_ConceptoVarios_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        '####### Agrego tipos de IVA
        With Me.cbIVA.Items
