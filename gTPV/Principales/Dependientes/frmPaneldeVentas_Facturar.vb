Public Class frmPaneldeVentas_Facturar
...
#Region "Funciones"
    ...
    Private Function GenerarFactura(ByVal id_cliente As Integer) As Boolean
        ...
        rst("obs").Value = Me.txtObs.Text
        rst.Update()

        Dim id As Integer = rst("id").Value
        My.m_db.CloseRst(rst)

        My.m_db.Execute("UPDATE db_tickets SET estado='FACTURADO', fh_finaliza=#" & Format(Now, "MM/dd/yyyy HH:mm") & "#, id_factura=" & id & " WHERE id=" & Me.IdRef)
...
#Region "Manejadores"
    ...
    Private Sub ShellApp(ByVal command As String)
        ...
        Select Case cmd
            ...
            Case "NEW_OK"
                If MsgBox("¿Esta seguro de que desea generar la factura al cliente con los datos que ha establecido?", MsgBoxStyle.OkCancel + MsgBoxStyle.Question) <> MsgBoxResult.Ok Then Exit Select
