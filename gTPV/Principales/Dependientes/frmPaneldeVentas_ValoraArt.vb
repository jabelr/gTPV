Public Class frmPaneldeVentas_ValoraArt
    Public IdRef As Integer

    Public intTipo As Integer = 0
...
#Region "Eventos Auxiliares"
    ...
    Private Sub Rbt_1_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Rbt_1.CheckedChanged, Rbt_2.CheckedChanged, Rbt_3.CheckedChanged
        If Not CType(sender, RadioButton).Checked Then Exit Sub
        Me.BtOK.Enabled = True
        Me.LblName.Text = CType(sender, RadioButton).Text
        Me.intTipo = CType(sender, RadioButton).Tag
    End Sub
#End Region
