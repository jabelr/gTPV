Public Class frmCompras_SelectArt
    Public Id_Ref As Integer = -1


#Region "Eventos Principales"
    Private Sub frmCompras_SelectArt_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim i As Integer = 0

        '####### Cargo solo las categorias de los artículos que tienen articulos asociados
